...
<p align="justify">
    Primeiro projeto de reactJS, desenvolvemos do zero uma sidebar e um post com comentários, com opções de comentar, excluir e aplaudir um comentário, por ser um projeto sem banco de dados nós comentamos e estes comentários irão acumular ao longo do post por meio de componentes com funções, imitando uma aplicação real.
</p>
